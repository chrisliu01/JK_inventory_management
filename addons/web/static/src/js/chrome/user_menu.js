...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .fail(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.eclink.ca/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.eclink.ca/documentation/user', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.eclink.ca/buy', '_blank');
    },
});
